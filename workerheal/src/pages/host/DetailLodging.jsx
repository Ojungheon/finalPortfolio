...
import ReadOnlyAccommodationAndImageUpload from '../../components/host/ReadOnlyAccommodationAndImageUpload';
import ReadOnlyTagAndFacility from '../../components/host/ReadOnlyTagAndFacility';
...
const DetailLodging = () => {
  ...
  useEffect(() => {
    ...
    fetch(`http://${API_SERVER}/api/host/lodging/detail?no=${businessNo}`, {
      method: 'GET',
      headers: {
        token: `${token}`,
      },
  ...
  return (
    <>
      <Breadcrumb>사업장 등록현황 &gt; 숙소 상세조회 &gt;</Breadcrumb>
      <Layout>
        <AccommodationWrapper>
          <ReadOnlyAccommodationAndImageUpload detailData={detailData} />
        </AccommodationWrapper>
        <TagAndFacilityWrapper>
          <ReadOnlyTagAndFacility detailData={detailData} />
        </TagAndFacilityWrapper>
        <DetailsWrapper>
