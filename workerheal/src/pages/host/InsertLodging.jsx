...
const InsertLodging = () => {
  ...
  // const handleAccommodationChange = (data) => {
  //   setFormData((prev) => ({
  //     ...prev,
  //     hostNo: data.hostNo, // 예: 숙소 업로드 컴포넌트에서 hostNo, lodgingNo 등을 전달
  //     lodgingNo: data.lodgingNo,
  ...
  return (
    <>
      <Breadcrumb>사업장 목록 &gt; 사업장 등록 &gt; 숙소 등록 &gt;</Breadcrumb>
      <Layout>
