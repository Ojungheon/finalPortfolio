...
import EnrollProgramListData from '../../../../components/admin/managePackage/enroll/EnrollProgramListData';
...
const EnrollProgramList = () => {
  ...
  useEffect(() => {
    setLoading(true);
    fetch(
      `http://${API_SERVER}/api/manager/packages/list/program?page=${currentPage}&pageSize=10`,
      {
...
export default EnrollProgramList;
