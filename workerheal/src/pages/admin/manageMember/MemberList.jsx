...
import MemberListData from '../../../components/admin/manageMember/MemberListData';
...
const MemberList = () => {
  ...
  const [members, setMembers] = useState([]); // 패키지 데이터 상태
  ...
  useEffect(() => {
    ...
    fetch(
      `http://${API_SERVER}/api/manager/member/list?page=${currentPage}&pageSize=10`,
      {
      ...
      .then((data) => {
        ...
        setMembers(data.content || []); // 실제 패키지 데이터는 content 안에 있음
