...
const OfficePayment = ({ availableMileage, price, setPayType }) => {
  // const [selectedPayment, setSelectedPayment] = useState('bankTransfe');
  const [selectedPayment, setSelectedPayment] = useState('kakao'); // 태훈 수정
  const [mileage, setMileage] = useState('');

  useEffect(() => {
    setPayType(selectedPayment);
  }, [selectedPayment]);
      ...
      <Layout>
        ...
        <Section>
          ...
          >
            ...
            <option value="tossCard">신용카드</option>
          </Select>
        </Section>
