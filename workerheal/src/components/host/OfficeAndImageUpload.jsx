    ...
    <>
      ...
      <AccomWrapper>
        <FieldContainer style={{ gridColumn: 'span 2' }}>
          <FormLabel htmlFor="name">오피스명</FormLabel>
          <Input
            type="text"
            name="name"
            placeholder="오피스"
        ...
        <FieldContainer>
          <FormLabel htmlFor="capacity">수용 인원</FormLabel>
          <CapacityWrapper>
            <Input
              type="number"
              name="capacity"
        ...
        {/* ✅ 추가된 입력 필드: 오픈 & 마감 시간 (두 번째 줄) */}
        <FieldContainer>
          <FormLabel htmlFor="open">오픈 시간</FormLabel>
          <Input
            type="time"
            name="open"
            value={formData.open}
        ...
        <FieldContainer>
          <FormLabel htmlFor="close">마감 시간</FormLabel>
          <Input
            type="time"
            name="close"
...
export default OfficeAndImageUpload;
